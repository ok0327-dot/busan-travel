...
const CATEGORIES = {
  ...
  bar:         { label: "술집",   emoji: "🍺", icon: "ph-beer-stein",     color: "#7c3aed", letter: "술" },
...
const PHOSPHOR_MARKER_PATHS = {
  bar:         'M236.86,28.42A8,8,0,0,0,232,24H24a8,8,0,0,0-6.16,13.11L120,160.71V208H88a8,8,0,0,0,0,16h80a8,8,0,0,0,0-16H136V160.71l102.16-123.6A8,8,0,0,0,236.86,28.42ZM215.07,40,194.59,64.74,180,49.34V40Z',
